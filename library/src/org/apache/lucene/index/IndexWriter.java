...
/**
  ...
  #IndexWriter(Directory, Analyzer, boolean, org.apache.lucene.index.IndexWriter.MaxFieldLength) constructor} determines
  whether a new index is created, or whether an existing index is
  opened.  Note that you can open an index with <code>create=true</code>
  even while readers are using the index.  The old readers will 
  continue to search the "point in time" snapshot they had opened, 
  and won't see the newly created index until they re-open.  There are
  also {@link #IndexWriter(Directory, Analyzer, org.apache.lucene.index.IndexWriter.MaxFieldLength) constructors}
  ...
  #updateDocument(org.apache.lucene.index.Term, Document) updateDocument} (which just deletes
...
public class IndexWriter implements Closeable {
   ...
   * {#commit} and then using {@link org.apache.lucene.index.IndexReader#open} to
   ...
   * org.apache.lucene.index.IndexReader#reopen}, but that call will simply forward
   ...
   *  org.apache.lucene.index.IndexWriter#setTermIndexInterval} except that setting
   ...
   *  be obtained)
   * @throws java.io.IOException if the directory cannot be read/written to, or
   ...
   *  has this index open (<code>write.lock</code> could not
   *  be obtained)
   * @throws java.io.IOException if the directory cannot be
   ...
   * @param indexingChain the {@link org.apache.lucene.index.DocConsumer} chain to be used to
   *  process documents
   ...
   *  org.apache.lucene.index.IndexWriter#getReader}.  Default value is {@link
   *  org.apache.lucene.index.IndexReader#DEFAULT_TERMS_INDEX_DIVISOR}. */
   ...
   *
   * @see org.apache.lucene.index.IndexWriter.MaxFieldLength
   */
  ...
  */
   ...
   *  {@link org.apache.lucene.index.IndexReader#numDeletedDocs}
   ...
   * 
   *  You can also just call {@link #commit(java.util.Map)} directly
   ...
   *  org.apache.lucene.index.IndexReader#getCommitUserData}.  Note that when
  ...
  /**
   * Specifies maximum field length (in number of tokens/terms) in {@link org.apache.lucene.index.IndexWriter} constructors.
