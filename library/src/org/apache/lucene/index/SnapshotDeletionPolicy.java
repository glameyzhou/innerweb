...
/** A {@link org.apache.lucene.index.IndexDeletionPolicy} that wraps around any other
 *  {@link org.apache.lucene.index.IndexDeletionPolicy} and adds the ability to hold and
 *  later release a single "snapshot" of an index.  While
 *  the snapshot is held, the {@link org.apache.lucene.index.IndexWriter} will not
 *  remove any files associated with it even if the index is
 *  otherwise being actively, arbitrarily changed.  Because
 *  we wrap another arbitrary {@link org.apache.lucene.index.IndexDeletionPolicy}, this
 *  gives you the freedom to continue using whatever {@link
 *  org.apache.lucene.index.IndexDeletionPolicy} you would normally want to use with your
