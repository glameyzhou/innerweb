...
public class BooleanQuery extends Query implements Iterable<BooleanClause> {
  ...
  /** Constructs an empty boolean query.
   *
   * {@link org.apache.lucene.search.Similarity#coord(int,int)} may be disabled in scoring, as
  ...
  /** Returns true iff {@link org.apache.lucene.search.Similarity#coord(int,int)} is disabled in
