...
public class TimeLimitingCollector extends Collector {
   ...
   * @param timeAllowed max time allowed for collecting hits after which {@link org.apache.lucene.search.TimeLimitingCollector.TimeExceededException} is thrown
   */
