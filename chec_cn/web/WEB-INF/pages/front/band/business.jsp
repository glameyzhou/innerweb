...
<div class="box">
    ...
    <div class="content">
        <div class="neiye-left">
            <div class="left-tit">${rootCategory.name}</div>
        ...
        <div class="neiye-right">
            <div class="weizhi">您所在的位置：<a href="${basePath}">首页</a>&nbsp;>&nbsp;<a href="${basePath}business.htm">${rootCategory.name}</a></div>
            <div class="right-con"><p>${rootCategory.describe}</p></div>
        </div>
    </div>
