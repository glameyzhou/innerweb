...
public abstract class Cache<K,V> implements Closeable {
  ...
  /**
   * Called by {@link #synchronizedCache(org.apache.lucene.util.cache.Cache)}. This method
   * returns a {@link org.apache.lucene.util.cache.Cache.SynchronizedCache} instance that wraps
   * this instance by default and can be overridden to return
   * e. g. subclasses of {@link org.apache.lucene.util.cache.Cache.SynchronizedCache} or this
