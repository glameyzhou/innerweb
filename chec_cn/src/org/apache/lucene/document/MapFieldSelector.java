...
/**
 * A {@link org.apache.lucene.document.FieldSelector} based on a Map of field names to
 * {@link FieldSelectorResult}s
 * 
 */
public class MapFieldSelector implements FieldSelector {

	private static final long serialVersionUID = -3525236528425245086L;
	 ...
	 *            maps from field names (String) to {@link FieldSelectorResult}s
	 */
	...
	public MapFieldSelector(List<String> fields) {
		fieldSelections = new HashMap<String, FieldSelectorResult>(fields
				.size() * 5 / 3);
