...
public final class Field extends AbstractField implements Fieldable,
		Serializable {
	private static final long serialVersionUID = -5088242132368106549L;
	...
	public static enum Index {
		 ...
		 * the storing of norms. Note that you can also separately
		 * enable/disable norms by calling {@link org.apache.lucene.document.Field#setOmitNorms}. No norms
	...
	public static enum TermVector {
		 ...
		 * the document's terms and their number of occurrences in that
		 * document.
		 */
		YES {
			@Override
	 ...
	 * {@link org.apache.lucene.index.IndexWriter#addDocument(Document)} has been called.
	 * 
	 * @param name
	 *            The name of the field
	 * @param reader
