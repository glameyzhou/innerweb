...
/**
 * <p>
 * This class provides a {@link org.apache.lucene.document.Field} that enables indexing of numeric values
 ...
 * use {@link org.apache.lucene.search.NumericRangeQuery} or {@link org.apache.lucene.search.NumericRangeFilter}. To sort
 * according to a <code>NumericField</code>, use the normal numeric sort types,
 * eg {@link org.apache.lucene.search.SortField#INT}. <code>NumericField</code> values can also be loaded
 * directly from {@link org.apache.lucene.search.FieldCache}.
 * </p>
 * 
 * <p>
 * By default, a <code>NumericField</code>'s value is not stored but is indexed
 * for range filtering and sorting. You can use the
 * {@link #NumericField(String, org.apache.lucene.document.Field.Store,boolean)} constructor if you need to
 ...
 * {@link #NumericField(String,int, org.apache.lucene.document.Field.Store,boolean)} if you'd like to change
 * the value. Note that you must also specify a congruent value when creating
 * {@link org.apache.lucene.search.NumericRangeQuery} or {@link org.apache.lucene.search.NumericRangeFilter}. For low cardinality
 ...
 * <code>precisionStep</code></a> configuration, see {@link org.apache.lucene.search.NumericRangeQuery}.
 * The format of indexed values is described in {@link org.apache.lucene.util.NumericUtils}.
 * 
 * <p>
 ...
 * 
 * <p>
 * More advanced users can instead use {@link org.apache.lucene.analysis.NumericTokenStream} directly, when
 * indexing numbers. This class is a wrapper around this token stream type for
 * easier, more intuitive usage.
 * </p>
 * 
 * <p>
 * <b>NOTE:</b> This class is only used during indexing. When retrieving the
 * stored field value from a {@link org.apache.lucene.document.Document} instance after search, you will
 * get a conventional {@link org.apache.lucene.document.Fieldable} instance where the numeric values are
 * returned as {@link String}s (according to <code>toString(value)</code> of the
 * used data type).
 * 
 * <p>
 * <font color="red"><b>NOTE:</b> This API is experimental and might change in
 * incompatible ways in the next release.</font>
 * 
 * @since 2.9
 */
public final class NumericField extends AbstractField {

	private static final long serialVersionUID = -5088435597094214709L;
	private final NumericTokenStream tokenStream;

	/**
	 * Creates a field for numeric values using the default
	 * <code>precisionStep</code> {@link org.apache.lucene.util.NumericUtils#PRECISION_STEP_DEFAULT}
	 * (4). The instance is not yet initialized with a numeric value, before
	 * indexing a document containing this field, set a value using the various
	 * set<em>???</em>Value() methods. This constructor creates an indexed, but
	 * not stored field.
	 * 
	 * @param name
	 *            the field name
	...
	/** Returns a {@link org.apache.lucene.analysis.NumericTokenStream} for indexing the numeric value. */
	 ...
	 * {@link org.apache.lucene.document.Field.Store#YES} is chosen).
	 */
