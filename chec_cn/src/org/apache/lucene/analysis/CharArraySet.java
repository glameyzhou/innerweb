...
public class CharArraySet extends AbstractSet<Object> {
  ...
  /**
   * Returns an unmodifiable {@link org.apache.lucene.analysis.CharArraySet}. This allows to provide
   * unmodifiable views of internal sets for "read-only" use.
   * 
   * @param set
   *          a set for which the unmodifiable set is returned.
   * @return an new unmodifiable {@link org.apache.lucene.analysis.CharArraySet}.
  ...
  /**
   * Returns a copy of the given set as a {@link org.apache.lucene.analysis.CharArraySet}. If the given set
   * is a {@link org.apache.lucene.analysis.CharArraySet} the ignoreCase property will be preserved.
   * 
   * @param set
   *          a set to copy
   * @return a copy of the given set as a {@link org.apache.lucene.analysis.CharArraySet}. If the given set
   *         is a {@link org.apache.lucene.analysis.CharArraySet} the ignoreCase property will be
   *         preserved.
   */
  ...
  /**
   * Efficient unmodifiable {@link org.apache.lucene.analysis.CharArraySet}. This implementation does not
   * delegate calls to a give {@link org.apache.lucene.analysis.CharArraySet} like
   * {@link java.util.Collections#unmodifiableSet(java.util.Set)} does. Instead is passes
   * the internal representation of a {@link org.apache.lucene.analysis.CharArraySet} to a super
