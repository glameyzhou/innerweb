...
public final class TeeSinkTokenFilter extends TokenFilter {
  ...
  /**
   * Returns a new {@link org.apache.lucene.analysis.TeeSinkTokenFilter.SinkTokenStream} that receives all tokens consumed by this stream.
   */
   ...
   * @see org.apache.lucene.analysis.TeeSinkTokenFilter.SinkFilter
   */
  ...
  /**
   * Adds a {@link org.apache.lucene.analysis.TeeSinkTokenFilter.SinkTokenStream} created by another <code>TeeSinkTokenFilter</code>
  ...
  /**
   * A filter that decides which {@link org.apache.lucene.util.AttributeSource} states to store in the sink.
   */
  public static abstract class SinkFilter {
    /**
     * Returns true, iff the current state of the passed-in {@link org.apache.lucene.util.AttributeSource} shall be stored
     * in the sink. 
     */
    public abstract boolean accept(AttributeSource source);
    
    /**
     * Called by {@link org.apache.lucene.analysis.TeeSinkTokenFilter.SinkTokenStream#reset()}. This method does nothing by default
  ...
  public static final class SinkTokenStream extends TokenStream {
    private final List<State> cachedStates = new LinkedList<State>();
    private State finalState;
    private Iterator<State> it = null;
