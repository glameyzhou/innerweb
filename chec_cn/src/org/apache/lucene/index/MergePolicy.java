...
public abstract class MergePolicy implements java.io.Closeable {
   ...
   * the index. {@link org.apache.lucene.index.IndexWriter} calls this when its
   * {@link org.apache.lucene.index.IndexWriter#optimize()} method is called. This call is always
