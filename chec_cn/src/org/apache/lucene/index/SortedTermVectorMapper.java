...
/**
 * Store a sorted collection of {@link TermVectorEntry}s.  Collects all term information
...
public class SortedTermVectorMapper extends TermVectorMapper{
  ...
  /**
   * Stand-in name for the field in {@link org.apache.lucene.index.TermVectorEntry}.
   */
  public static final String ALL = "_ALL_";

  /**
   *
   * @param comparator A Comparator for sorting {@link org.apache.lucene.index.TermVectorEntry}s
   */
  ...
  /**
   * The TermVectorEntrySet.  A SortedSet of {@link org.apache.lucene.index.TermVectorEntry} objects.  Sort is by the comparator passed into the constructor.
   *<br/>
   * This set will be empty until after the mapping process takes place.
   *
   * @return The SortedSet of {@link org.apache.lucene.index.TermVectorEntry}.
   */
