...
public abstract class IndexReader implements Cloneable,Closeable {
   ...
   * {@link org.apache.lucene.index.IndexReader#getFieldNames(org.apache.lucene.index.IndexReader.FieldOption)}.
   */
   ...
   * reader is closed.
   * 
   * @throws java.io.IOException in case an IOException occurs in commit() or doClose()
   *
   * @see #incRef
   */
   ...
   *  {@link org.apache.lucene.index.IndexCommit}.  You should pass readOnly=true, since it
   *  gives much better concurrent performance, unless you
   *  intend to do write operations (delete documents or
   *  change norms) with the reader.
   ...
   * @param commit the specific {@link org.apache.lucene.index.IndexCommit} to open;
   * see {@link org.apache.lucene.index.IndexReader#listCommits} to list all commits
   * in a directory
   * @param deletionPolicy a custom deletion policy (only used
   *  if you use this reader to perform deletes or to set
   *  norms); see {@link IndexWriter} for details.
   ...
   * IndexWriter#commit(java.util.Map)}, from current index
   * segments file.  This will return null if {@link
   * IndexWriter#commit(java.util.Map)} has never been called for
   * this index.
   * 
   * @param directory where the index resides.
   ...
   * @throws java.io.IOException if index cannot be accessed
   ...
   * @throws java.io.IOException if term vectors cannot be accessed or if they do not exist on the field and doc. specified.
   * 
   */
   ...
   * calling terms(), {@link org.apache.lucene.index.TermEnum#next()} must be called
   * on the resulting enumeration before calling other methods such as
   * {@link org.apache.lucene.index.TermEnum#term()}.
   * @throws java.io.IOException if there is a low-level IO error
   */
  ...
  /** Returns an unpositioned {@link org.apache.lucene.index.TermDocs} enumerator.
   * @throws java.io.IOException if there is a low-level IO error
   */
   ...
   * Applications should call {@link #deleteDocument(int)} or {@link #deleteDocuments(org.apache.lucene.index.Term)}.
   */
   ...
   * @see org.apache.lucene.index.IndexReader.FieldOption
   */
   ...
   *  it by calling {@link org.apache.lucene.index.IndexReader#open(org.apache.lucene.index.IndexCommit,boolean)}
