...
public class ParallelReader extends IndexReader {
  ...
  *     of {@link org.apache.lucene.index.IndexReader#maxDoc()}
  * @throws java.io.IOException if there is a low-level IO error
  */
  public void add(IndexReader reader, boolean ignoreStoredFields)
    ...
    Collection<String> fields = reader.getFieldNames(FieldOption.ALL);
   ...
   * (see {@link org.apache.lucene.index.IndexReader#reopen()}).
   * <p>
