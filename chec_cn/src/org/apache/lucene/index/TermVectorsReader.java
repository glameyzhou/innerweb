...
class TermVectorsReader implements Cloneable {
   ...
   * @throws java.io.IOException if there is an error reading the term vector files
   */ 
...
class ParallelArrayTermVectorMapper extends TermVectorMapper
{
   ...
   * @return The {@link org.apache.lucene.index.TermFreqVector} based on the mappings.
   */
