...
import com.glamey.framework.utils.watermark.CommandButton.ButtonStyle;
/**
 * 主界面
...
public class MainFrame extends JFrame {
	...
	//水印位置
	private String toward[] = { "右下", "左下", "右上", "左上", "正中", "左上->右下","左下->右下" };
	
	//字体样式
	private String fontstyle[] = {"普通","粗体","斜体","粗体&斜体"};
	private int fontstyles[] = {Font.PLAIN, Font.BOLD, Font.ITALIC, Font.BOLD | Font.ITALIC};
	
	private String fontcolor[] = {"蓝色","青色","绿色","红色","灰色","深灰色","浅灰色","洋红色","桔黄色","粉红色","黄色","黑色","白色"};
	private Color colors[] = {Color.blue, Color.cyan, Color.green, Color.red, Color.gray,Color.darkGray, Color.lightGray, 
			Color.magenta, Color.orange, Color.pink,Color.yellow, Color.black, Color.white};
	
	private String scales[] = {"不缩放", "25%", "50%", "75%","125%","150%","175%","200%"};
	private float imgScales[] = {1.0f, 0.25f, 0.5f, 0.75f, 1.25f, 1.5f, 1.75f, 2.0f};
	
	
	private JComboBox fontCB, //字体
	towardCB, //水印位置
	fontcolorCB, //水印颜色
	fontstyleCB, //字体样式
	scaleCB;	//缩放比
	private JTextField filepathTF, savepathTF, markTF, fontsizeTF /*字体大小*/;
