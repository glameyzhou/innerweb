...
<table width="100%" border="0" cellpadding="0" cellspacing="0" background="${basePath}res/jeecms/img/admin/top_bg.jpg">
    <tr>
        ...
        <td align="left">&nbsp;&nbsp;
            <img src="${basePath}res/jeecms/img/admin/welconlogin-icon.png"><span style="color: #FFF;padding: 0 10px 0 5px ;">用户名 &nbsp;&nbsp;周杨&nbsp;[超级管理员]</span>
            ...
            <a style="color: #FFF;padding: 0 10px 0 5px ;" href="${basePath}home.jsp" id="logout" target="_blank">回首页</a>&nbsp;</span>
        </td>
    </tr>
</table>
<%--<ul class="menu">
