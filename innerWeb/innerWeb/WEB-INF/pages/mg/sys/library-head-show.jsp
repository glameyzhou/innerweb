...
<div class="body-box">
    ...
    <form method="post" action="${basePath}mg/sys/meta/library-head/update.htm" id="jvForm"
            ...
            <tr>
                <td width="100%" class="pn-fcontent" colspan="2" align="center">
                    <textarea name="content" cols="100" rows="8"
                              style="width:95%;height:300px;visibility:hidden;">${libraryHeadContent.value}</textarea>
                </td>
            </tr>
            <tr>
