...
<script type="text/javascript">
	...
	function edit(cateId){
		window.location = '${basePath}super/news/category-show.do?cateId='+cateId;
	}
	function del(cateId){
		if(!confirm("确定要删除此栏目,删除后新闻讲没有分类?")){
			return ;
		}
		window.location = '${basePath}super/news/category-del.do?cateId='+cateId;
	}
</script>
</head>
<body>
<div class="body-box">
	<div class="rhead">
		<div class="rpos">当前位置: 首页  - 新闻 - 栏目列表 </div>
		<form class="ropt">
			<input type="submit" value="添加" onclick="this.form.action='${basePath}super/news/category-show.do';">
		</form>
		<div class="clear"></div>
	</div>
	<form action="${basePath}super/news/category-list.do" method="get" style="padding-top:5px;">
		<div>
